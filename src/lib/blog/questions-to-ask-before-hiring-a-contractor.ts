export const post = {
  ...
  readTime: "7 min read",
  excerpt:
    "The questions you ask before signing a contract matter more than the ones you ask after. Here's the list every homeowner should work through.",
  metaDescription:
  ...
  content: `
    ...
    <p>General experience matters, but experience with your specific type of project matters more. A contractor who has built dozens of custom homes may not be the right fit for a kitchen remodel, and vice versa. Ask how many projects similar to yours they've completed in the last two to three years. Look for a track record that aligns with both the scope and the style of your renovation.</p>

    <h2>3. Can I See References From Recent Projects?</h2>
    <p>Any contractor can show you their best project photos. References give you something more valuable: an honest account of what it's like to work with them. Ask for three to five references from projects completed in the past twelve months, and actually call them. The questions that matter most are about communication, timeline accuracy, how they handled unexpected problems, and whether the final cost matched the original quote.</p>
    <p>If a contractor can't or won't provide recent references, treat it as a serious red flag regardless of how polished their portfolio looks.</p>

    <h2>4. Who Will Be on Site Daily?</h2>
    ...
    <p>Payment terms should be tied to project milestones, not calendar dates. A fair schedule might look like 10% at signing, followed by payments at demolition completion, rough-in, and substantial completion, with a final holdback of 10% to 15% released after a walk-through and punch list completion.</p>
    <p>Be cautious of any contractor who asks for more than 30% upfront or who wants full payment before the project is finished. Front-loaded payment schedules remove your leverage if quality issues arise or if the contractor falls behind schedule.</p>

    <h2>9. Do You Pull Permits?</h2>
    <p>Any work that involves structural changes, electrical, plumbing, or HVAC modifications requires permits in most jurisdictions. The contractor should be pulling these permits, not you. When the contractor pulls the permit, they take legal responsibility for the work meeting code requirements. If they ask you to pull the permit yourself, or suggest skipping permits entirely, walk away. Unpermitted work can create serious problems when you sell your home and can void your homeowner's insurance.</p>

    <h2>10. What Warranty Do You Offer?</h2>
    <p>Ask about both workmanship warranty and material warranty. A standard workmanship warranty in the residential renovation industry is one to two years, meaning the contractor will return to fix defects in their work at no charge during that period. Material warranties are typically passed through from the manufacturer, but confirm how the contractor handles warranty claims if a product they supplied fails.</p>
    <p>Get the warranty terms in writing as part of your contract. A verbal promise of "we stand behind our work" means nothing if a problem surfaces eighteen months later and the contractor has moved on.</p>

    <h2>11. What Happens if the Project Goes Over Budget?</h2>
    <p>This is a question many homeowners are afraid to ask, but it's one of the most important. A fixed-price contract means the contractor absorbs cost overruns unless you approve a change order. A cost-plus contract means you pay actual costs plus a markup, and overruns land on you. Make sure you understand which type of contract you're signing and what protections exist if costs exceed the estimate.</p>
    <p>For fixed-price contracts, ask whether the quote includes a contingency allowance for unforeseen conditions like hidden water damage, outdated wiring, or structural issues behind walls. A 10% to 15% contingency is standard for renovation work and prevents the need for emergency change orders when surprises appear.</p>
